...
from ex2_0_utils import ConditionalRealNVP
...
if __name__ == "__main__":
    ...
    model = ConditionalRealNVP(input_dim=input_dim, num_coupling_layers=num_coupling_layers, 
    ...
    for epoch in range(epochs):
        ...
        for batch_id, (x, labels) in enumerate(tqdm(train_loader)):
            ...
            z, log_likelihood = model.inverse(x, labels)
    ...
    torch.save(model.state_dict(), f"saved_models/CondRealNVP_{num_coupling_layers}_coupling.pt")
